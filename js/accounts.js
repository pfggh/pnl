window.Accounts = (() => {
  ...
  const init = () => {
    ...
    // Add table click listener for actions
    accountsIssuesTableBody.addEventListener("click", async (e) => {
      const btn = e.target;
      if (btn.classList.contains("mark-fixed-btn")) {
      ...
      } else if (btn.classList.contains("delete-acc-btn")) {
